...
<section class="file-marker">
      ...
      <div class="row">
        <div class="col-lg-6 styleLeft">
          ...
          <li>Loosening of ground-in soils</li>
          <li>Shampooing</li>
          <li>Drying using vacuuming</li>
        </ul>
          <h3>Service Time:</h3> 1-3 Hours
          <h3>No. of Servicemen:</h3> 1-2 (depending on the size)
          <h3>Note:</h3>
          ...
          <div class="form-group">
           <h4 class="leftstyle">Select the Type:</h4>
              <select class="form-control" name="type">
                <option value="4">7 * 5 sq ft</option>
                <option value="5">10 * 8 sq ft</option>
              </select>
          </div>
