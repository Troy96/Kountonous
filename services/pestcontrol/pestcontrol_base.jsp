...
<section class="file-marker">
          ...
          <div class="row">
            ...
            <div class="row">
            	...
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="bedbugs.jsp">BedBugs</a></h2>
            </div>
            ...
            <hr/>
             ...
             <div class="row">
            	...
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="general.jsp">General</a></h2>
            </div>
            
            	<p style="text-align: left">Let our professionals take care of the things that "bug" you! Don't let Termites, Rodents, Cockroaches call your home theirs'. Ensure a pest free home by opting for a complete pest eradication service offered by Timesaverz and live life without worries!</p>
            	</div>
            	</div>	
            </div>
