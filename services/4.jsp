 ...
 <body>
  ...
  <div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="para">
				<p>Well maintained car interiors is essential for a comfortable drive. Proper interior cleaning for the upholstery, foot space, seatbelts, door handles, ac filters gives your car interior a great look too. Book a door-step professional car cleaning service anywhere in Bareilly</p>
			</div>
		</div>
	</div>
    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="cleaning_base.jsp">Car Spa</a></li>
          <li class="breadcrumb-item"><a href="carpet.jsp">Interior</a></li>
        </ol>
      </nav>
    </div>
  </div>
...
<section class="file-marker">
      ...
      <div class="row">
        <div class="col-lg-6 styleLeft">
          ...
          <h3>Interior</h3>
          <ul>
          <li>Roof foam cleaning</li>
          <li>Seat Shampooing</li>
          <li>Polishing of dashboard</li>
        </ul>
        
          <h3>Service Time:</h3> 3-4 Hours
          <h3>No. of Servicemen:</h3> 1-3 (depending on car type)
          <h3>Note:</h3>
          ...
          <div class="form-group">
           <h4 class="leftstyle">Select the Type:</h4>
              <select class="form-control" name="type">
                ...
                <option value="11">Mid Sized</option>
                <option value="12">Large SUV</option>
