 ...
 <body>
  ...
  <div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="para">
				<p>Your expensive AC needs regular care and servicing or repairing to ensure it is at its optimum best! At Timesaverz, you can avail of convenient, quick and easy repair services for your AC, no matter the day or time! Our range of services include complete repair, installation of a new AC and even regular servicing of all brands across all localities of Mumbai, Navi Mumbai and Thane. Don't worry anymore when your precious AC starts making those funny noises or if it seems to have stopped cooling like the way it once used to. Get the home service specialists to help out instead!</p>
			</div>
		</div>
	</div>
    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="carpet.jsp">AC</a></li>
        </ol>
      </nav>
    </div>
  </div>
...
<section class="file-marker">
      ...
      <div class="row">
        <div class="col-lg-6 styleLeft">
          ...
          <h3>Wet Service Time:</h3> 30 mins / AC
          <li>Cleaning of coil, filter with water</li>
          <li>Clearing of drainage pipe</li>
          <li>Checking of gas level</li>
          <h3>No. of Servicemen:</h3> 1-2 
          <h3>Note:</h3>
          Parts replacement, material cost, gas charging, transportation cost (if applicable) would be on actual and are to be settled with the service partner
Inspection charge if any, would be adjusted against the final bill
AMC[Annual Maintainence Contract] available for hassle free maintenance</p>
      </div>
      <div class="col-lg-6">
          ...
          <div class="form-group">
           <h4 class="leftstyle">Select the Type:</h4>
              <select class="form-control" name="type">
                <option value="14">Split Dry</option>
                <option value="15">Split Wet</option>
                <option value="16">Window Wet</option>
