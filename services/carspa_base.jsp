  ...
  <div class="container">
	...
	<div class="row">
		<div class="col-lg-6">
				...
				<img src="../images/carspa1.jpg" width="550" height="220">
...
<section class="file-marker">
          ...
          <div class="row">
            ...
            <div class="row">
            	...
            	<a href="../getAllServiceManToUsers.jsp?categ=3"><img class="img-circle" src="../images/carspa3.jpg" width="150" height="150"></a>
            	</div>
            </div>
            	<div class="col-lg-8">
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="../getAllServiceManToUsers.jsp?categ=4">Interior</a></h2>
            </div>
            ...
            <hr/>
             ...
             <div class="row">
            	<div class="col-lg-4">
            	<div class="image-base">	
            	<a href="../getAllServiceManToUsers.jsp?categ=3"><img class="img-circle" src="../images/carspa2.jpg" width="150" height="150"></a>
            	</div>
            </div>
            	<div class="col-lg-8">
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="../getAllServiceManToUsers.jsp?categ=3">Complete</a></h2>
            </div>
