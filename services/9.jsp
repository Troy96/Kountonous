...
<html>
<title>Electrician Handyman Services</title>
<head>
 ...
 <body>
  ...
  <div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="para">
				<p>Don't put off minor or major electrical repairs or equipment installations at home anymore! Let the home service specialists come over and fix all electrical issues in a professional and safe manner. Keep your beautiful home up-to-date and secure with timely handyman repairs. Our certified experts are trained to offer solutions for all kinds of home electrical problems</p>
			</div>
		</div>
	</div>
    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="9.jsp">Electrician</a></li>
        </ol>
      </nav>
    </div>
  </div>
...
Time pending for your service cannot be carried over for your next service</p>
      </div>
      <div class="col-lg-6">
