...
<section class="file-marker">
          ...
          <div class="row">
            ...
            <div class="row">
            	...
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="ac.jsp">AC</a></h2>
            </div>
            
            	<p style="text-align: left">Keep your cool when your AC is down and out. Get a Timesaverz professional now and feel the change in your room temperature (literally).</p>
            	</div>
            	</div>	
            </div>
            <hr/>
             ...
             <div class="row">
            	...
            	<div class="wrapper">
            	<div class="heading">
            	<h2><a  href="laptop.jsp">Laptop</a></h2>
            </div>
            
            	<p style="text-align: left">Don't let the tech geek in you scream out in frustration. Let Timesaverz save the day and get your laptop fixed in a jiffy!</p>
            	</div>
            	</div>	
            </div>
